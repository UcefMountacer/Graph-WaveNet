...
def generate_train_val_test(seq_length_x,seq_length_y,traffic_df_filename,y_start,dow,output_dir):
...
generate_train_val_test(12,12,'metr-la.h5',1,'store_true','data/metr')
